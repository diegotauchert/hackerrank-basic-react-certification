...
function Payment(amount, receiverT) {
  Activity.call(this,amount);
  this.receiver = receiverT;

  this.setReceiver = function(myReceiver){
...
function Refund(amount, senderT) {
  Activity.call(this,amount);
  this.sender = senderT;

  this.setSender = function(mySender){
...
Refund.prototype.setSender = (myReceiver) => {
  this.sender = myReceiver;
}
